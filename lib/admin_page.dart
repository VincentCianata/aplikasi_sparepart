...
class _AdminPageState extends State<AdminPage> {
  ...
  Future<void> _loadAllTransactions() async {
    ...
    if (token != null) {
      setState(() {
        _transactionsFuture = TransactionService.fetchAllTransactions(token);
      });
    }
  }
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                ...
                child: ExpansionTile(
                  ...
                  title: Text(
                    "User ${tx.userId} - ${formatCurrency.format(tx.totalAmount)}",
                    style: const TextStyle(
                      fontWeight: FontWeight.bold,
                      fontSize: 16,
                    ),
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "ID: ${item['spare_part_id']} • Qty: ${item['quantity']}",
                                          style: const TextStyle(
                                            fontSize: 12,
                                            color: Colors.grey,
                                          ),
